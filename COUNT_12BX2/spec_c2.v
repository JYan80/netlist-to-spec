...
module COUNT_12BX2_spec (
  ...
  always @(posedge X1026_138_ZN or negedge X3_323_Z) begin
    if (!X3_323_Z) begin
      ...
      a1 <= X8710_Z ? b1 : (~((COUNT1N|X154_21_ZN)&X8259_ZN&X745_64_ZN));
      b1 <= X8710_Z ? b2 : (~((COUNT3N|X154_21_ZN)&X8279_ZN&X30_6_ZN));
      a0 <= X8710_Z ? a1 : (~((COUNT1N|X214_21_ZN)&X605_189_ZN&X636_64_ZN));
      b0 <= X8710_Z ? b10 : (~((COUNT3N|X214_21_ZN)&X630_189_ZN&X744_64_ZN));
      b10 <= X8710_Z ? DT[0] : (~((COUNT3N|X8409_ZN)&X8267_ZN&X8514_ZN));
    end
  end
  ...
  always @(posedge X1027_138_ZN or negedge X3_323_Z) begin
    if (!X3_323_Z) begin
      ...
      a10 <= X8710_Z ? b0 : (~((COUNT1N|X8409_ZN)&X8269_ZN&X8515_ZN));
      a3 <= X8710_Z ? b3 : (~((COUNT3N|X1889_ZN)&X8280_ZN&X72_6_ZN));
      a2 <= X8710_Z ? a3 : (~((COUNT3N|X8418_ZN)&X8278_ZN&X8510_ZN));
      b2 <= X8710_Z ? a2 : (~((COUNT1N|X8418_ZN)&X8258_ZN&X4_6_ZN));
      a9 <= X8710_Z ? a10 : (~((COUNT1N|X8419_ZN)&X688_189_ZN&X212_6_ZN));
    end
  end
  ...
  always @(posedge X1027_138_ZN or negedge X1676_Z) begin
    if (!X1676_Z) begin
      ...
      b9 <= X8710_Z ? a9 : (~((COUNT3N|X8419_ZN)&X8274_ZN&X8543_ZN));
    end
  end
  ...
  always @(posedge X1027_138_ZN or negedge X3_323_Z) begin
    if (!X3_323_Z) begin
      ...
      a4 <= X412_46_Z ? b5 : (~((COUNT3N|X8397_ZN)&X8261_ZN&X8522_ZN));
      a6 <= X412_46_Z ? b6 : (~((COUNT3N|X420_ZN)&X569_189_ZN&X8557_ZN));
      b5 <= X412_46_Z ? a5 : (~((COUNT1N|X8411_ZN)&X8270_ZN&X8527_ZN));
      b4 <= X412_46_Z ? a4 : (~((COUNT1N|X8397_ZN)&X8271_ZN&X8500_ZN));
      b3 <= X412_46_Z ? b4 : (~((COUNT1N|X1889_ZN)&X661_189_ZN&X8559_ZN));
      b6 <= X412_46_Z ? b7 : (~((COUNT1N|X420_ZN)&X8275_ZN&X8526_ZN));
      a5 <= X412_46_Z ? a6 : (~((COUNT3N|X8411_ZN)&X593_189_ZN&X8549_ZN));
      a7 <= X412_46_Z ? b8 : (~((COUNT1N|X8405_ZN)&X568_189_ZN&X8517_ZN));
      b7 <= X412_46_Z ? a7 : (~((COUNT3N|X8405_ZN)&X8277_ZN&X8511_ZN));
    end
  end
  ...
  always @(posedge X1027_138_ZN or negedge X1676_Z) begin
    if (!X1676_Z) begin
      ...
      b8 <= X412_46_Z ? a8 : (~((COUNT1N|X8403_ZN)&X684_189_ZN&X8531_ZN));
      a8 <= X412_46_Z ? DT[1] : (~((COUNT3N|X8403_ZN)&X8276_ZN&X8519_ZN));
    end
  end
